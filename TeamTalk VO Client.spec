...
a = Analysis(
    ...
    hiddenimports=['teamtalk_client', 'teamtalk_client.tt', 'teamtalk_client.client', 'ui.tabs.system', 'platform_paths', 'sound_manager', 'objc', 'AppKit', 'Quartz', 'chat_history', 'global_hotkeys', 'pyaudio', 'i18n', 'mss', 'mss.tools', 'screen_capture', 'system_audio'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
...
app = BUNDLE(
    ...
    info_plist={
        'CFBundleShortVersionString': '6.3.3',
        'CFBundleVersion': '6.3.3',
