...
class MainFrame(wx.Frame):
    ...
    def _refresh_recent_channels_menu(self) -> None:
        try:
            ...
            if not channels:
                menu.Append(wx.ID_ANY, _("(Keine letzten Kanäle)")).Enable(False)
                return
            for ch in channels:
    ...
    def _build_menu(self):
        menubar = wx.MenuBar()
        file_menu = wx.Menu()
        open_tt = file_menu.Append(wx.ID_ANY, _("TeamTalk-Datei öffnen...") + "\tCtrl+O")
        new_client = file_menu.Append(wx.ID_ANY, _("Neuen Client starten") + "\tCtrl+N")
        sound_menu = wx.Menu()
        self._sound_input_menu = wx.Menu()
        self._sound_output_menu = wx.Menu()
        sound_menu.AppendSubMenu(self._sound_input_menu, _("Eingabegeräte"))
        sound_menu.AppendSubMenu(self._sound_output_menu, _("Ausgabegeräte"))
        ...
        file_menu.AppendSubMenu(sound_menu, _("Sound-Konfiguration"))
        record_convo = file_menu.Append(wx.ID_ANY, _("Konversationen aufzeichnen..."))
        prefs_item = file_menu.Append(wx.ID_PREFERENCES, _("Einstellungen...") + "\tF4")
        file_menu.AppendSeparator()
        con_connect = file_menu.Append(wx.ID_ANY, _("Verbinden"))
        con_disconnect = file_menu.Append(wx.ID_ANY, _("Trennen"))
        con_reconnect = file_menu.Append(wx.ID_ANY, _("Neu verbinden"))
        file_menu.AppendSeparator()
        self._menu_auto_reconnect = file_menu.AppendCheckItem(wx.ID_ANY, _("Automatisch neu verbinden"))
        con_autoreconnect = self._menu_auto_reconnect
        file_menu.AppendSeparator()
        con_join_root = file_menu.Append(wx.ID_ANY, _("Root-Kanal beitreten"))
        con_leave = file_menu.Append(wx.ID_ANY, _("Kanal verlassen"))
        file_menu.AppendSeparator()
        ...
        file_menu.AppendSubMenu(favorites_menu, _("Schnellverbindung (Cmd+1–9)"))
        self.Bind(wx.EVT_MENU_OPEN, self._on_favorites_menu_open)
        file_menu.AppendSeparator()
        con_server_check = file_menu.Append(wx.ID_ANY, _("Server prüfen"))
        file_menu.AppendSeparator()
        import_servers = file_menu.Append(wx.ID_ANY, _("Serverliste importieren..."))
        export_servers = file_menu.Append(wx.ID_ANY, _("Serverliste exportieren..."))
        file_menu.AppendSeparator()
        settings_backup = file_menu.Append(wx.ID_ANY, _("Einstellungen sichern (Backup)..."))
        settings_restore = file_menu.Append(wx.ID_ANY, _("Einstellungen wiederherstellen..."))
        history_export = file_menu.Append(wx.ID_ANY, _("Sitzungsverlauf exportieren..."))
        file_menu.AppendSeparator()
        ...
        # Kanal
        chan_menu = wx.Menu()
        chan_create = chan_menu.Append(wx.ID_ANY, _("Kanal erstellen...") + "\tF7")
        chan_edit = chan_menu.Append(wx.ID_ANY, _("Kanal bearbeiten..."))
        chan_delete = chan_menu.Append(wx.ID_ANY, _("Kanal löschen..."))
        chan_menu.AppendSeparator()
        chan_join = chan_menu.Append(wx.ID_ANY, _("Kanal beitreten...") + "\tCtrl+J")
        chan_leave = chan_menu.Append(wx.ID_ANY, _("Kanal verlassen") + "\tCtrl+L")
        chan_menu.AppendSeparator()
        chan_info = chan_menu.Append(wx.ID_ANY, _("Kanalinfo..."))
        chan_info_speak = chan_menu.Append(wx.ID_ANY, _("Kanalinfo vorlesen"))
        chan_stats_speak = chan_menu.Append(wx.ID_ANY, _("Kanalstatistik vorlesen"))
        chan_state_speak = chan_menu.Append(wx.ID_ANY, _("Kanalzustand vorlesen"))
        chan_tt_url = chan_menu.Append(wx.ID_ANY, _("TT-URL für Kanal kopieren"))
        chan_bans = chan_menu.Append(wx.ID_ANY, _("Sperren im Kanal anzeigen..."))
        chan_note = chan_menu.Append(wx.ID_ANY, _("Kanal-Notiz bearbeiten..."))
        chan_msg = chan_menu.Append(wx.ID_ANY, _("Kanalnachricht senden..."))
        chan_view_msgs = chan_menu.Append(wx.ID_ANY, _("Kanalnachrichten anzeigen..."))
        chan_menu.AppendSeparator()
        chan_files_menu = wx.Menu()
        chan_file_upload = chan_files_menu.Append(wx.ID_ANY, _("Datei hochladen..."))
        chan_file_download = chan_files_menu.Append(wx.ID_ANY, _("Datei herunterladen..."))
        chan_file_delete = chan_files_menu.Append(wx.ID_ANY, _("Datei löschen..."))
        chan_file_refresh = chan_files_menu.Append(wx.ID_ANY, _("Dateiliste aktualisieren"))
        chan_menu.AppendSubMenu(chan_files_menu, _("Dateien"))
        chan_stream_menu = wx.Menu()
        chan_stream_file = chan_stream_menu.Append(wx.ID_ANY, _("Mediendatei streamen..."))
        chan_stream_yt = chan_stream_menu.Append(wx.ID_ANY, _("YouTube streamen..."))
        chan_stream_sc = chan_stream_menu.Append(wx.ID_ANY, _("SoundCloud streamen..."))
        chan_stream_twitch = chan_stream_menu.Append(wx.ID_ANY, _("Twitch streamen..."))
        chan_stream_bandcamp = chan_stream_menu.Append(wx.ID_ANY, _("Bandcamp streamen..."))
        chan_stream_vimeo = chan_stream_menu.Append(wx.ID_ANY, _("Vimeo streamen..."))
        chan_stream_mixcloud = chan_stream_menu.Append(wx.ID_ANY, _("Mixcloud streamen..."))
        ...
        chan_menu.AppendSubMenu(chan_stream_menu, _("Streaming"))
        chan_menu.AppendSeparator()
        self._recent_channels_menu = wx.Menu()
        chan_menu.AppendSubMenu(self._recent_channels_menu, _("Letzte Kanäle"))
        ...
        # Benutzer
        user_menu = wx.Menu()
        user_info = user_menu.Append(wx.ID_ANY, _("Benutzerinfo..."))
        user_info_speak = user_menu.Append(wx.ID_ANY, _("Benutzerinfo vorlesen"))
        user_message = user_menu.Append(wx.ID_ANY, _("Private Nachricht..."))
        user_mute_menu = wx.Menu()
        user_mute_voice = user_mute_menu.Append(wx.ID_ANY, _("Sprache stummschalten"))
        user_mute_media = user_mute_menu.Append(wx.ID_ANY, _("Mediendatei stummschalten"))
        user_menu.AppendSubMenu(user_mute_menu, _("Stummschalten"))
        user_volume = user_menu.Append(wx.ID_ANY, _("Benutzerlautstärke..."))
        user_stereo_menu = wx.Menu()
        user_stereo_normal = user_stereo_menu.Append(wx.ID_ANY, _("Normal (beide)"))
        user_stereo_left = user_stereo_menu.Append(wx.ID_ANY, _("Nur links"))
        user_stereo_right = user_stereo_menu.Append(wx.ID_ANY, _("Nur rechts"))
        user_menu.AppendSubMenu(user_stereo_menu, _("Stereo-Kanal"))
        user_note = user_menu.Append(wx.ID_ANY, _("Notiz &bearbeiten..."))
        user_adv = wx.Menu()
        user_vol_up = user_adv.Append(wx.ID_ANY, _("Lauter") + "\tCtrl+Right")
        user_vol_down = user_adv.Append(wx.ID_ANY, _("Leiser") + "\tCtrl+Left")
        user_relay_voice = user_adv.Append(wx.ID_ANY, _("Sprachstream weiterleiten"))
        user_relay_media = user_adv.Append(wx.ID_ANY, _("Medienstream weiterleiten"))
        user_position = user_adv.Append(wx.ID_ANY, _("Benutzer positionieren..."))
        user_allow_menu = wx.Menu()
        user_allow_voice = user_allow_menu.Append(wx.ID_ANY, _("Sprache erlauben"))
        user_allow_video = user_allow_menu.Append(wx.ID_ANY, _("Video erlauben"))
        user_allow_desktop = user_allow_menu.Append(wx.ID_ANY, _("Desktop erlauben"))
        user_allow_media = user_allow_menu.Append(wx.ID_ANY, _("Mediendatei erlauben"))
        user_allow_text = user_allow_menu.Append(wx.ID_ANY, _("Kanalnachricht erlauben"))
        user_allow_menu.AppendSeparator()
        user_allow_all_voice = user_allow_menu.Append(wx.ID_ANY, _("Alle Sprache erlauben"))
        user_allow_all_video = user_allow_menu.Append(wx.ID_ANY, _("Alle Video erlauben"))
        user_allow_all_desktop = user_allow_menu.Append(wx.ID_ANY, _("Alle Desktop erlauben"))
        user_allow_all_media = user_allow_menu.Append(wx.ID_ANY, _("Alle Mediendatei erlauben"))
        user_allow_all_text = user_allow_menu.Append(wx.ID_ANY, _("Alle Kanalnachrichten erlauben"))
        user_adv.AppendSubMenu(user_allow_menu, _("Uebertragung erlauben"))
        user_menu.AppendSubMenu(user_adv, _("Erweitert"))
        user_menu.AppendSeparator()
        user_op = user_menu.Append(wx.ID_ANY, _("Operator geben/nehmen"))
        user_kick_menu = wx.Menu()
        user_kick = user_kick_menu.Append(wx.ID_ANY, _("Aus Kanal kicken..."))
        user_kick_ban = user_kick_menu.Append(wx.ID_ANY, _("Aus Kanal kicken + Bannen..."))
        user_kick_server = user_kick_menu.Append(wx.ID_ANY, _("Vom Server kicken..."))
        user_kick_ban_server = user_kick_menu.Append(wx.ID_ANY, _("Vom Server kicken + Bannen..."))
        user_kick_menu.AppendSeparator()
        user_ban = user_kick_menu.Append(wx.ID_ANY, _("Bannen..."))
        user_menu.AppendSubMenu(user_kick_menu, _("Kicken / Sperren"))
        user_tx_menu = wx.Menu()
        user_tx_voice = user_tx_menu.AppendCheckItem(wx.ID_ANY, _("Sprache senden"))
        user_tx_video = user_tx_menu.AppendCheckItem(wx.ID_ANY, _("Video senden"))
        user_tx_desktop = user_tx_menu.AppendCheckItem(wx.ID_ANY, _("Desktop senden"))
        user_tx_media = user_tx_menu.AppendCheckItem(wx.ID_ANY, _("Mediendatei senden"))
        user_tx_msg = user_tx_menu.AppendCheckItem(wx.ID_ANY, _("Kanalnachricht senden"))
        user_tx_desktop_access = user_tx_menu.AppendCheckItem(wx.ID_ANY, _("Desktopzugriff erlauben"))
        user_menu.AppendSubMenu(user_tx_menu, _("Sendekontrolle"))
        user_menu.AppendSeparator()
        user_subs = user_menu.Append(wx.ID_ANY, _("Abonnements..."))
        user_move = user_menu.Append(wx.ID_ANY, _("Benutzer verschieben..."))
        user_store_move = user_menu.Append(wx.ID_ANY, _("Zielkanal merken"))
        ...
        # Server
        server_menu = wx.Menu()
        server_online = server_menu.Append(wx.ID_ANY, _("Online-Benutzer..."))
        server_broadcast = server_menu.Append(wx.ID_ANY, _("Servernachricht senden..."))
        server_stats = server_menu.Append(wx.ID_ANY, _("Serverstatistiken..."))
        server_bans = server_menu.Append(wx.ID_ANY, _("Sperren (Server) anzeigen..."))
        server_admin = server_menu.Append(wx.ID_ANY, _("Administration öffnen"))
        server_props = server_menu.Append(wx.ID_ANY, _("Servereigenschaften..."))
        ...
        profile_nick = profile_menu.Append(wx.ID_ANY, _("Nickname ändern..."))
        profile_status = profile_menu.Append(wx.ID_ANY, _("Status setzen..."))
        profile_question = profile_menu.AppendCheckItem(wx.ID_ANY, _("Frage-Modus"))
        profile_hear = profile_menu.AppendCheckItem(wx.ID_ANY, _("Mich selbst hören"))
        profile_tts = profile_menu.AppendCheckItem(wx.ID_ANY, _("TTS aktiv"))
        profile_desktop = profile_menu.AppendCheckItem(wx.ID_ANY, _("Desktop senden"))
        profile_menu.AppendSeparator()
        notif_menu = wx.Menu()
        notif_chat = notif_menu.AppendCheckItem(wx.ID_ANY, _("Chat vorlesen"))
        notif_private = notif_menu.AppendCheckItem(wx.ID_ANY, _("Privat vorlesen"))
        notif_system = notif_menu.AppendCheckItem(wx.ID_ANY, _("System vorlesen"))
        notif_own = notif_menu.AppendCheckItem(wx.ID_ANY, _("Eigene Nachrichten vorlesen"))
        profile_menu.AppendSubMenu(notif_menu, _("Benachrichtigungen"))
        ...
        audio_menu.AppendSeparator()
        audio_agc = audio_menu.AppendCheckItem(wx.ID_ANY, _("AGC"))
        audio_denoise = audio_menu.AppendCheckItem(wx.ID_ANY, _("Rauschunterdrückung"))
        audio_echo = audio_menu.AppendCheckItem(wx.ID_ANY, _("Echounterdrückung"))
        audio_apply_effects = audio_menu.Append(wx.ID_ANY, _("Effekte anwenden"))
        audio_menu.AppendSeparator()
        audio_apply = audio_menu.Append(wx.ID_ANY, _("Audio anwenden"))
        audio_refresh = audio_menu.Append(wx.ID_ANY, _("Geräte aktualisieren"))
        audio_menu.AppendSeparator()
        ...
        # Video
        video_menu = wx.Menu()
        video_tx = video_menu.AppendCheckItem(wx.ID_ANY, _("Video senden"))
        video_menu.AppendSeparator()
        video_settings = video_menu.Append(wx.ID_ANY, _("Video-Einstellungen..."))
        video_refresh = video_menu.Append(wx.ID_ANY, _("Video-Geräte aktualisieren"))
        menubar.Append(video_menu, _("Video"))

        # Aufnahmen
        rec_menu = wx.Menu()
        rec_convo = rec_menu.Append(wx.ID_ANY, _("Konversationen aufzeichnen..."))
        rec_menu.AppendSeparator()
        rec_start = rec_menu.Append(wx.ID_ANY, _("Aufnahme starten..."))
        rec_stop = rec_menu.Append(wx.ID_ANY, _("Aufnahme stoppen"))
        rec_menu.AppendSeparator()
        rec_scheduled = rec_menu.Append(wx.ID_ANY, _("Geplante Aufnahmen..."))
        ...
        auto_menu.AppendSeparator()
        auto_translate = auto_menu.AppendCheckItem(wx.ID_ANY, _("Chat-Übersetzung aktivieren"))
        auto_channel_sum = auto_menu.AppendCheckItem(wx.ID_ANY, _("Auto-Kanal-Zusammenfassung"))
        auto_menu.AppendSeparator()
        auto_user_watcher = auto_menu.Append(wx.ID_ANY, _("Nutzerwatcher..."))
        auto_chat_search = auto_menu.Append(wx.ID_ANY, _("Chat-Verlauf durchsuchen..."))
        ...
        # Hilfe
        help_menu = wx.Menu()
        help_settings = help_menu.Append(wx.ID_PREFERENCES, _("Einstellungen...") + "\tCmd+,")
        ...
        help_stats = help_menu.Append(wx.ID_ANY, _("Verbindungsstatistiken..."))
        help_stats_speak = help_menu.Append(wx.ID_ANY, _("Statistiken vorlesen"))
        help_menu.AppendSeparator()
        help_saved_msgs = help_menu.Append(wx.ID_ANY, _("Gespeicherte Nachrichten..."))
        help_menu.AppendSeparator()
        help_manual = help_menu.Append(wx.ID_ANY, _("Handbuch"))
        help_hotkeys = help_menu.Append(wx.ID_ANY, _("Tastenkürzel-Referenz..."))
        help_menu.AppendSeparator()
        help_check_update = help_menu.Append(wx.ID_ANY, _("Auf Updates prüfen..."))
        help_update_mgr = help_menu.Append(wx.ID_ANY, _("Updates & Versionen..."))
        help_menu.AppendSeparator()
        help_changelog = help_menu.Append(wx.ID_ANY, _("Changelog"))
    ...
    def _populate_sound_device_menu(self, menu: wx.Menu, kind: str) -> None:
        ...
        if not devices:
            item = menu.Append(wx.ID_ANY, _("Keine Geräte"))
            item.Enable(False)
            return
        for dev in devices:
