...
int32_t evvw_annoCallback(int32_t a0, int32_t a1, int32_t a2)
{
    return (int32_t)annoCallback(EVV_AT(delta_state *, a0), EVV_AT(const void *, a1), EVV_AT(const void *, a2));
}

int32_t evvw_esprCallback(int32_t a0)
{
    return (int32_t)esprCallback(EVV_AT(delta_state *, a0));
}

int32_t evvw_placePhoneme(int32_t a0, int32_t a1, int32_t a2, int32_t a3)
{
    return (int32_t)placePhoneme(EVV_AT(delta_state *, a0), EVV_AT(const void *, a1), EVV_AT(const void *, a2), EVV_AT(const void *, a3));
}

int32_t evvw_placePhonemeText(int32_t a0, int32_t a1, int32_t a2, int32_t a3)
{
    return (int32_t)placePhonemeText(EVV_AT(delta_state *, a0), EVV_AT(const void *, a1), EVV_AT(const void *, a2), EVV_AT(const void *, a3));
}

int32_t evvw_synthesizingWord(int32_t a0, int32_t a1)
{
    return (int32_t)synthesizingWord(EVV_AT(delta_state *, a0), EVV_AT(const void *, a1));
}

int32_t evvw_voiceChangeCallback(int32_t a0, int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6)
{
    return (int32_t)voiceChangeCallback(EVV_AT(delta_state *, a0), EVV_AT(const void *, a1), EVV_AT(void *, a2), EVV_AT(void *, a3), EVV_AT(void *, a4), EVV_AT(void *, a5), EVV_AT(void *, a6));
}
