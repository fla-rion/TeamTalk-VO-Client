...
class ChannelsTab(wx.Panel):
    ...
    def __init__(self, parent: wx.Window, frame: MainFrame) -> None:
        ...
        self.user_list.SetName("Nutzerliste")
        ...
        self.channel_list = wx.ListBox(self)
        self.channel_list.SetName("Channel Liste")
        self.channel_list.SetMinSize((-1, 140))
        self.channel_list.Bind(wx.EVT_LISTBOX_DCLICK, self.on_channel_list_join)
        self.channel_join_btn = wx.Button(self, label="Channel beitreten")
        self.channel_join_btn.SetName("Channel beitreten")
        ...
        sizer.Add(ch_row, 0, wx.LEFT | wx.RIGHT | wx.BOTTOM | wx.EXPAND, 8)

        # --- Members ---
        members_box = wx.StaticBox(self, label="Mitglieder im aktuellen Channel")
        members_sizer = wx.StaticBoxSizer(members_box, wx.VERTICAL)
        self.channel_members = wx.ListBox(self)
        self.channel_members.SetName("Channel Mitglieder")
