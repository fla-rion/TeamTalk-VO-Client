...
class RecordingsBrowserDialog(QDialog):
    def __init__(self, parent, settings_store) -> None:
        ...
        self.setWindowTitle("Aufnahmen-Browser")
        self.resize(680, 480)
        ...
        self._list.setAccessibleName("Aufnahmen")
        layout.addWidget(self._list, 1)

        btn_row = QHBoxLayout()
        self._play_btn = QPushButton("&Abspielen")
        self._play_btn.setAccessibleName("Aufnahme abspielen")
        self._play_btn.clicked.connect(self._on_play)
        btn_row.addWidget(self._play_btn)

        self._folder_btn = QPushButton("&Ordner öffnen")
        self._folder_btn.setAccessibleName("Ordner der Aufnahme öffnen")
        ...
        self._delete_btn.setAccessibleName("Aufnahme löschen")
        self._delete_btn.clicked.connect(self._on_delete)
        btn_row.addWidget(self._delete_btn)

        btn_row.addStretch()

        self._refresh_btn = QPushButton("A&ktualisieren")
    ...
    def _on_open_folder(self) -> None:
        ...
        try:
            ...
            QMessageBox.warning(self, "Fehler", f"Ordner öffnen fehlgeschlagen: {exc}")
    ...
    def _on_delete(self) -> None:
        ...
        try:
            ...
            QMessageBox.warning(self, "Fehler", f"Löschen fehlgeschlagen: {exc}")
