...
int32_t evvw_addStreamArrayPtValC(int32_t a0, int32_t a1, int32_t a2, int32_t a3)
{
    return (int32_t)addStreamArrayPtValC(EVV_AT(void *, a0), EVV_AT(const int16_t *, a1), EVV_AT(const int16_t *, a2), EVV_AT(const int32_t *, a3));
}

int32_t evvw_addStreamArraySsValC(int32_t a0, int32_t a1, int32_t a2, int32_t a3, int32_t a4)
{
    return (int32_t)addStreamArraySsValC(EVV_AT(void *, a0), EVV_AT(const int16_t *, a1), EVV_AT(const int16_t *, a2), EVV_AT(const int32_t *, a3), EVV_AT(const int32_t *, a4));
}

int32_t evvw_resetStreamArrayC(int32_t a0)
{
    return (int32_t)resetStreamArrayC(EVV_AT(void *, a0));
}
