...
class MainFrame(wx.Frame):
    ...
    def on_menu_manual(self, _event):
        ...
        manual_text = (
            "TeamTalk VoiceOver Client – Benutzerhandbuch\n"
            "=============================================\n"
            "\n"
            "Inhaltsverzeichnis\n"
            "------------------\n"
            ...
            "4. Tab Kanäle\n"
            "=============\n"
            "Zeigt die Kanalstruktur des Servers und die Benutzer im aktuellen Kanal.\n"
            "\n"
            "Bereich 'Kanalbaum'\n"
            "  Baumansicht aller Kanäle auf dem Server. Mit den Pfeiltasten navigieren.\n"
            "  Enter oder Doppelklick: Kanal beitreten.\n"
            "\n"
            "Bereich 'Benutzer im Kanal'\n"
            "  Liste aller Benutzer im aktuellen Kanal.\n"
            "  Eintragsformat: Nickname (Benutzername), Status, Eigenschaften\n"
            "\n"
            ...
            "10. Tab ElevenLabs TTS\n"
            "======================\n"
            "Eigene Sprachausgabe über ElevenLabs-KI in den Kanal sprechen lassen.\n"
            "Erfordert einen ElevenLabs-API-Schlüssel (in den Einstellungen hinterlegen).\n"
            "\n"
            "\n"
            "11. Tab Desktop\n"
            "===============\n"
