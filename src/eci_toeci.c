...
int32_t evvw_closeIO(int32_t a0)
{
    return (int32_t)closeIO(EVV_AT(delta_state *, a0));
}

int32_t evvw_initializeIO(int32_t a0)
{
    return (int32_t)initializeIO(EVV_AT(delta_state *, a0));
}
