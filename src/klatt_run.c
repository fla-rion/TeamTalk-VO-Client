...
int32_t evvw_callSynthesizeArray(int32_t a0, int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int32_t a7, int32_t a8, int32_t a9, int32_t a10, int32_t a11, int32_t a12, int32_t a13, int32_t a14, int32_t a15, int32_t a16, int32_t a17, int32_t a18, int32_t a19, int32_t a20, int32_t a21, int32_t a22, int32_t a23, int32_t a24)
{
    return (int32_t)callSynthesizeArray(EVV_AT(DeltaThis *, a0), EVV_AT(Cell *, a1), EVV_AT(Cell *, a2), EVV_AT(Cell *, a3), EVV_AT(Cell *, a4), EVV_AT(Cell *, a5), EVV_AT(Cell *, a6), EVV_AT(Cell *, a7), EVV_AT(Cell *, a8), EVV_AT(Cell *, a9), EVV_AT(Cell *, a10), EVV_AT(Cell *, a11), EVV_AT(Cell *, a12), EVV_AT(Cell *, a13), a14, a15, a16, a17, a18, a19, a20, a21, a22, a23, a24);
}

int32_t evvw_turnLazyWriteOn(int32_t a0)
{
    return (int32_t)turnLazyWriteOn(EVV_AT(DeltaThis *, a0));
}
