...
int32_t evvw_callInsertLastDictString(int32_t a0, int32_t a1, int32_t a2, int32_t a3)
{
    return (int32_t)callInsertLastDictString(EVV_AT(delta_state *, a0), EVV_AT(const void *, a1), EVV_AT(const delta_token *, a2), EVV_AT(const delta_token *, a3));
}

int32_t evvw_callUserDictLookup(int32_t a0, int32_t a1, int32_t a2, int32_t a3)
{
    return (int32_t)callUserDictLookup(EVV_AT(delta_state *, a0), EVV_AT(const void *, a1), EVV_AT(const delta_token *, a2), EVV_AT(const delta_token *, a3));
}
